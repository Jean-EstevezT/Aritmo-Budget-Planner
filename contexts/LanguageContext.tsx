...
const translations = {
  ...
  es: {
    ...
    'trans.edit': 'Editar Transacción',
    'trans.desc': 'Descripción',
    'trans.amount': 'Monto',
    'trans.curr': 'Moneda',
    'trans.date': 'Fecha',
    'trans.cat': 'Categoría',
    ...
    'trans.origCurr': 'Original: ',
    'trans.deleteTitle': 'Eliminar Transacción',
    'trans.deleteConfirm': '¿Estás seguro de que quieres eliminar esta transacción? Esta acción no se puede deshacer.',
    ...
    'trans.yearly': 'Anual',
    'trans.start': 'Inicio / Próxima Fecha',
    ...
    'bills.nextDue': 'Próximo Vencimiento',
    'bills.paidMonth': 'Pagado (Este Mes)',
    'bills.allCaughtUp': '¡Todo al día! No hay cuentas pendientes.',
    ...
    'budget.dist': 'Distribución de Presupuesto',
    ...
    'savings.noGoals': 'No tienes metas de ahorro aún.',
    ...
    'debt.totalLoan': 'Préstamo Total',
    'debt.minPayment': 'Pago Mínimo',
    ...
    'settings.incomeCat': 'Categorías de Ingreso',
    'settings.expenseCat': 'Categorías de Gasto',
    'settings.addCat': 'Nueva Categoría',
    'settings.name': 'Nombre de Categoría',
    'settings.color': 'Color',
    'settings.create': 'Crear Categoría',
    'settings.danger': 'Zona de Peligro',
    'settings.deleteAccount': 'Eliminar Cuenta',
    'settings.deleteConfirm': '¿Estás seguro? Esto borrará todos tus datos permanentemente.',
    'settings.enterPassToDelete': 'Ingresa tu contraseña para confirmar',
    ...
    'settings.backupSuccess': '¡Respaldo creado con éxito!',
    ...
    'about.imp.cloud': 'Sincronización en la Nube (Opcional)',
    'about.imp.cloudDesc': 'Sincroniza datos de forma segura entre dispositivos.',
    'about.imp.security': 'Encriptación Avanzada',
    'about.imp.securityDesc': 'Protección de datos locales mejorada.',
    'about.imp.theme': 'Soporte de Temas',
    'about.imp.themeDesc': 'Colores personalizables y modo oscuro.',
    'about.more': '+ Más próximamente',
    'about.feedback.title': '¿Tienes sugerencias?',
    ...
    'login.description': 'Aritmo está diseñado para ayudarte a tomar el control de tus finanzas de forma segura y offline.',
